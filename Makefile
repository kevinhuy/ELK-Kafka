...
LOGSTASH_CONTAINER_PORT_SYSLOG = 5514
LOGSTASH_CONTAINER_PORT_ANSIBLE = 5000
...
run_logstash:
	...
	-p $(LOGSTASH_CONTAINER_PORT_SYSLOG):$(LOGSTASH_CONTAINER_PORT_SYSLOG) \
	-p $(LOGSTASH_CONTAINER_PORT_ANSIBLE):$(LOGSTASH_CONTAINER_PORT_ANSIBLE) \
...
run_consumer_ansible:
	...
	-d \
	-v $(KAFKA_CONSUMER_PYTHON_SCRIPTS_SRC):$(KAFKA_CONSUMER_PYTHON_SCRIPTS_DST) \
	--name $(KAFKA_CONSUMER_NAME_ANSIBLE_CALLBACK) \
	$(KAFKA_CONSUMER_IMAGE):$(KAFKA_CONSUMER_TAG) \
